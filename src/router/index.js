...
const routes = [
  ...
  //esta parte esta descativada hasta la publicacion en playstore
   /*
    {
    path: '/download',
    name: 'Download',
  ...
  {
    path: '/blog/earthquakee',
    name: 'earthquakee',
    // route level code-splitting
    // this generates a separate chunk (about.[hash].js) for this route
    // which is lazy-loaded when the route is visited.
    component: () => import(/* webpackChunkName: "about" */ '../views/Earthquakee.vue')
  },
  {
    path: '/blog/philosofhy',
    name: 'Philosofhy',
    // route level code-splitting
    // this generates a separate chunk (about.[hash].js) for this route
    // which is lazy-loaded when the route is visited.
    component: () => import(/* webpackChunkName: "about" */ '../views/Philosofhy.vue')
  },
  {
    path: '/blog/sistem',
    name: 'Sistem',
    ...
    // this generates a separate chunk (about.[hash].js) for this route
    // which is lazy-loaded when the route is visited.
    component: () => import(/* webpackChunkName: "about" */ '../views/Sistem.vue')
  },
  {
    path: '/blog/student',
    name: 'Student',
